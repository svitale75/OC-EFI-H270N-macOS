# An OpenCore (0.6.9) EFI that enables a Gigabyte H270N-WIFI based PC to run macOS Monterey 12.7.1
...
**User's to do:**
- If macOS  Monterey 12.7.1 is already installed then:
...
- If macOS  Monterey 12.7.1 is NOT already installed then:
1. Download **OpneCore Legacy Patcher**
2. Create mac OS istaller for macOS ** Monterey** to a drive
